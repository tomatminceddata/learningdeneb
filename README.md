...
Using triangle down markers that allow easy discovery of the segemnts inside a single stack that contribute to a given cumulative percentage like 25%, 50%, and 75%.
